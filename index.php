		...
		<script type="text/javascript">
			...
			daum.maps.event.addListener(map, 'mousemove', function (mouseEvent) {
				...
				if (drawingFlag) {
					...
					if(length > 0) {
						...
						content = '<div class="info_circle">반경 <span class="number">' + radius + '</span>m</div>';
			...
			daum.maps.event.addListener(map, 'rightclick', function (mouseEvent) {
				if(map.getLevel()<6)
				{
					...
					///////////////////////////////////////////////////////////////////////////////////////////////////
					var rad = Math.PI / 180;
					var latitude = drawingLine.getLength() / 6378137;
					...
					//var radius_circle_in_identify = Math.abs(centerPosition.getLat() + longitude);
					var radius_circle_in_identify = longitude;
					///////////////////////////////////////////////////////////////////////////////////////////////////
					//alert("centerPosition.getLat() = "+centerPosition.getLat());
					...
					for (var i = 0; i < positions_child_house.length; i ++) {
						...
						x_circle_in_identify_child_house[i] = x_child_house[i]-centerPosition.getLat();
						y_circle_in_identify_child_house[i] = y_child_house[i]-centerPosition.getLng();
					...
					for (var i = 0; i < positions_frequentzonechild.length; i ++) {
						...
						x_circle_in_identify_frequentzonechild[i] = x_frequentzonechild[i]-centerPosition.getLat();
						y_circle_in_identify_frequentzonechild[i] = y_frequentzonechild[i]-centerPosition.getLng();
					...
					for (var i = 0; i < positions_park.length; i ++) {
						...
						x_circle_in_identify_park[i] = x_park[i]-centerPosition.getLat();
						y_circle_in_identify_park[i] = y_park[i]-centerPosition.getLng();
					...
					for (var i = 0; i < positions_hospital.length; i ++) {
						...
						x_circle_in_identify_hospital[i] = x_hospital[i]-centerPosition.getLat();
						y_circle_in_identify_hospital[i] = y_hospital[i]-centerPosition.getLng();
					...
					for (var i = 0; i < positions_childprtc.length; i ++) {
						...
						x_circle_in_identify_childprtc[i] = x_childprtc[i]-centerPosition.getLat();
						y_circle_in_identify_childprtc[i] = y_childprtc[i]-centerPosition.getLng();
